...
> * [Element Template](./element-templates/concatenate-connector.json)
...
The generated element template can be found in [element-templates/template-connector.json](./element-templates/concatenate-connector.json).
